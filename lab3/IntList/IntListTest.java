...
public class IntListTest {
    ...
    public void testReverse() {
        ...
        IntList expA = IntList.of(1);
        IntList expB = IntList.of(6, 5, 4, 3, 2, 1);
        IntList expN = IntList.of();
        assertEquals(expN, IntList.reverse(N));
        assertEquals(expA, IntList.reverse(A));
        assertEquals(expB, IntList.reverse(B));
        assertEquals(IntList.of(6, 5, 4, 3, 2, 1), B);
    }
}
